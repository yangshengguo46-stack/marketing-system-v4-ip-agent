...
STARTUP_ONLY_FIELDS: dict[str, str] = {
    ...
    "minecontext": (
        "MineContextService is constructed once during Gateway startup; operator limits and source/runtime paths are captured by that process-local lifecycle manager."
    ),
    "scheduler": (
