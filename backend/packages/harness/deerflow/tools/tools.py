...
from deerflow.tools.builtins import (
    ...
    personal_ip_compile_video_method_distillation_tool,
    personal_ip_compile_video_method_skill_candidate_tool,
    ...
    personal_ip_read_differentiation_tool,
    ...
    personal_ip_record_asset_observation_tool,
    personal_ip_record_browser_observation_tool,
    personal_ip_record_differentiation_tool,
