...
发布回执、指标、复盘、证据晋升和视频制作台账是唯一运行状态；不得依据聊天重建
...
2. 先建立差异化论题：目标公众、希望形成的影响、替代选择、独有事实、选择理由、相信理由、主动舍弃、戏剧发动机和识别编码；达到试播状态后再进入长期圣经。
...
12. 登记发布、指标、影响力资产观察和复盘；达到观察门槛后才升级差异化与局部方法。
