...
> [!NOTE]
> **This branch is the IP Agent distribution.** DeerFlow remains the only Agent
> runtime. The customer product has three core boards: breakdown, writer brain
> and production; observations close the feedback loop instead of creating a
> fourth product center. Start with the runtime contract in
> [IP_AGENT.md](IP_AGENT.md) and the only current delivery record in
> [docs/IP_AGENT_PRODUCT_LEDGER.md](docs/IP_AGENT_PRODUCT_LEDGER.md). The
> [audit remediation file](docs/IP_AGENT_AUDIT_REMEDIATION_LEDGER.md) is a frozen
> closeout, and the
> [capability boundary file](docs/IP_AGENT_SKILL_CAPABILITY_BOUNDARY_LEDGER.md)
> is inventory only.
>
> Historical implementation notes were moved to
> [product/research/ip-agent/README_IP_AGENT_IMPLEMENTATION_NOTES_HISTORY_2026-08-05.md](product/research/ip-agent/README_IP_AGENT_IMPLEMENTATION_NOTES_HISTORY_2026-08-05.md).
