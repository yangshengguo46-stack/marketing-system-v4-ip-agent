...
> account filter. Consecutive cumulative post snapshots produce exact-interval
> deltas, always marked partial because tracked posts are not proof of complete
> account coverage. See
